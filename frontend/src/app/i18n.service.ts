...
const DICT: Record<string, { de: string; en: string }> = {
  ...
  'filter.oer':           { de: 'OER', en: 'OER' },
  'filter.art':           { de: 'Quellenart', en: 'Source type' },
  'filter.art.crawler':   { de: 'Crawler', en: 'Crawler' },
  'filter.art.node':      { de: 'Quelldatensatz', en: 'Source record' },
  'filter.art.bq':        { de: 'Bezugsquelle', en: 'Publisher' },
  'filter.art.both':      { de: 'QD + Bezugsquelle', en: 'Record + Publisher' },
  'filter.fieldProfile':  { de: 'Feld-Profil', en: 'Field profile' },
  'filter.more':          { de: 'Weitere Filter', en: 'More filters' },
  'filter.lrt':           { de: 'Inhaltstyp', en: 'Content type' },
